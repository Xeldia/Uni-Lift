...
import { saveUserProfile, signOut, supabase } from "../../../shared/lib/supabase";
        ...
        <div className="w-full">
          <div className="content-stretch flex h-[44px] items-start pb-px relative shrink-0 w-full">
            ...
            <button
              ...
              className={`flex-1 relative h-[43px] transition-all duration-200 group ${activeTab === "account" ? "bg-black" : "bg-[#f9f9f9] hover:bg-[#eaeaea]"}`}
            >
              <p className={`font-['Consolas:Bold',sans-serif] text-[10px] text-center tracking-[1px] whitespace-nowrap transition-transform duration-200 ${activeTab === "account" ? "text-white" : "text-black group-hover:scale-[1.05]"}`}>
                ACCOUNT
              </p>
            </button>
            <div className="w-px bg-black h-[43px]" />

            <Link to="/profile" className="flex-1 relative bg-[#f9f9f9] h-[43px] flex items-center justify-center hover:bg-[#eaeaea] transition-all duration-200 group">
              <p className="font-['Consolas:Bold',sans-serif] text-[10px] text-black text-center tracking-[1px] whitespace-nowrap transition-transform duration-200 group-hover:scale-[1.05]">PROFILE</p>
            </Link>
            <div className="w-px bg-black h-[43px]" />

            <button
              onClick={() => setActiveTab("security")}
              className={`flex-1 relative h-[43px] transition-all duration-200 group ${activeTab === "security" ? "bg-black" : "bg-[#f9f9f9] hover:bg-[#eaeaea]"}`}
            >
              <p className={`font-['Consolas:Bold',sans-serif] text-[10px] text-center tracking-[1px] whitespace-nowrap transition-transform duration-200 ${activeTab === "security" ? "text-white" : "text-black group-hover:scale-[1.05]"}`}>
                SECURITY
              </p>
            </button>
          </div>
          ...
          {activeTab === "account" && (
            <div className="px-[40px] py-[32px] flex flex-col gap-[28px]">
              ...
              <div className="flex flex-col gap-[12px]">
                ...
                <div className="border border-black p-[20px] bg-white flex items-center justify-between gap-[16px] transition-all duration-300 hover:shadow-[4px_4px_0px_0px_black] hover:-translate-y-[2px] hover:-translate-x-[2px]">
                  <div>
                    <p className="font-['Consolas:Bold',sans-serif] text-[9px] text-black tracking-[1.1px] mb-[6px]">CURRENT SESSION</p>
                    <p className="font-['Consolas:Regular',sans-serif] text-[9px] text-[#6a7282] tracking-[0.45px]">{authUser?.email} · Last sign in: {authUser?.last_sign_in_at ? new Date(authUser.last_sign_in_at).toLocaleString() : "N/A"}</p>
                  </div>
          ...
          {activeTab === "security" && (
            <div className="px-[40px] py-[32px] flex flex-col gap-[28px]">
              ...
              <div className="border border-black p-[20px] bg-white transition-all duration-300 hover:shadow-[4px_4px_0px_0px_black] hover:-translate-y-[2px] hover:-translate-x-[2px]">
                <p className="font-['Consolas:Bold',sans-serif] text-[9px] text-black tracking-[1px] mb-[6px]">RECENT SECURITY EVENT</p>
                <p className="font-['Consolas:Regular',sans-serif] text-[9px] text-[#6a7282]">Last sign in: {authUser?.last_sign_in_at ? new Date(authUser.last_sign_in_at).toLocaleString() : "Unknown"}</p>
              </div>
